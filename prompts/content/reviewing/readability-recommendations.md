...
description: Identify ways to improve clarity, flow, and value for a defined audience.
llm_tools:
  - ChatGPT
  - Microsoft Copilot
inputs:
...
Use this prompt when your draft feels dense or unfocused. The model returns high-level suggestions to increase clarity, impact, and resonance for the readers you specify.
